...
huggingface-cli download stable-diffusion-v1-5/stable-diffusion-v1-5 --local-dir checkpoints/StableDiffusion --exclude "*.ckpt" "*.safetensors" "*.bin"

huggingface-cli download stable-diffusion-v1-5/stable-diffusion-v1-5 --local-dir checkpoints/StableDiffusion --include "*.fp16.safetensors"

huggingface-cli download lllyasviel/control_v11p_sd15_lineart --local-dir "checkpoints/models/control_v11p_sd15_lineart" --exclude "*.bin" "*diffusion_pytorch_model.safetensors"

huggingface-cli download lllyasviel/Annotators sk_model.pth --local-dir "checkpoints/models/Annotators"

huggingface-cli download Johanan0528/MangaNinjia --local-dir checkpoints/MangaNinjia

huggingface-cli download openai/clip-vit-large-patch14 --local-dir "checkpoints/models/clip-vit-large-patch14" --exclude "*.bin" "*.h5" "*.msgpack"
